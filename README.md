...
👉 https://yoismail.github.io/Yomi-Ismail-Portfolio/
...
* ⚙️ Process and workflow optimization in real environments
...
### 💳 PayFlow Data Engineering Project

A production-style ETL pipeline built to simulate a fintech transaction system:

* Designed modular pipeline architecture (extract, transform, load)
* Built normalized + analytics-ready schema in PostgreSQL
* Implemented data cleaning, validation, and transformation logic
* Optimized data loading using batch processing
...
* Advanced ETL pipelines (batch + scalable architecture)
* Data warehouse optimization projects
* Production-level Data Engineering portfolio
